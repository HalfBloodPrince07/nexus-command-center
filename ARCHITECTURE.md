# NEXUS OS — System Architecture Documentation
...
4. [Agent Architecture (Phase 2 & 3)](#agent-architecture-phase-2--3)
5. [Database Design](#database-design)
6. [Vector Store Architecture](#vector-store-architecture)
7. [WebSocket Protocol Specification](#websocket-protocol-specification)
